    ...
    >
      <Toolbar sx={(theme) => navbarContainer(theme)}>
        ...
        {isMini ? null : (
          ...
          >
            <Icon fontSize="medium" style={{color:'#2a68af'}}>notifications</Icon>
          </IconButton>
          {renderMenu()}
          <SoftTypography
          variant="button"
      ...
      <div className="row align-items-center">
        <div className="col-lg-5 col-md-6 mt-4 pt-2 mt-sm-0 pt-sm-0">
          <div className="position-relative">
            <img src="UoN-Logo.jpg" className="rounded-md img-fluid mx-auto d-block" alt="Ebesa logo" />
          </div>
        </div>{/*end col*/}
        <div className="col-lg-7 col-md-6 mt-4 pt-2 mt-sm-0 pt-sm-0">
          <div className="section-title ms-lg-5">
            <h4 className="title mb-4">FoE- UoN</h4>
            <p className="text-muted">
            Faculty Of Engineering (University Of Nairobi) website is for...
            <p>We would like to welcome you to the FoE UoN website by the students for the students which will work as a link between the students body and the professional body.</p> 
            </p>
          </div>
        </div>{/*end col*/}
      </div>{/*end row*/}
