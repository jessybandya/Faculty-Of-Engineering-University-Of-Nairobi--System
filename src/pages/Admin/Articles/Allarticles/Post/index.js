...
function Post({ articleId, description, fileData, fileType, title, ownerId, timestamp }) {
  ...
  return (
    <TableRow hover role="checkbox" tabIndex={-1}>
        ...
        <RemoveRedEyeIcon style={{color:'#2a68af',cursor:'pointer'}} fontSize='medium'/>              
        </Link> 
        </TableCell>
        <TableCell align='right'>
        {comments.length}                 
        ...
        <TableCell align='right'>
         <DeleteForeverIcon onClick={deleteArticle} style={{color:'#2a68af',cursor:'pointer'}} fontSize='medium'/>                  
        </TableCell>
  </TableRow>
  )
}
