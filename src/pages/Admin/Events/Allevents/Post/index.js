...
const onUpload = async () => {
  ...
  return (
    ...
    <RemoveRedEyeIcon onClick={() => setShow1(true)} fontSize='medium' style={{color:'#2a68af',cursor:'pointer'}}/>                  
    </TableCell>
    <TableCell style={{color:'#2a68af'}} align='right'>
       {venue}                
    </TableCell>
   ...
   {status === true ?(
     <span style={{color:'#2a68af',fontWeight:'bold'}}>open</span>
   ):(
     <span style={{color:'#2a68af',fontWeight:'bold'}}>closed</span>
   )}
  </TableCell>
   <TableCell align='right'>
      <RemoveRedEyeIcon onClick={handleClickOpen} fontSize='medium' style={{color:'#2a68af',cursor:'pointer'}}/>                
  </TableCell>
 <TableCell align='right'>
 {status === true ?(
  <CloseIcon onClick={closeEvent} fontSize='medium' style={{color:'#2a68af',cursor:'pointer'}}/>                
 ):(
  <DoneAllIcon onClick={openEvent} fontSize='medium' style={{color:'#2a68af',cursor:'pointer'}}/>                
 )}
 <DeleteForeverIcon onClick={deleteEvent} fontSize='medium' style={{color:'#2a68af',cursor:'pointer'}}/>                
...
<AppBar style={{backgroundColor:'#fff'}} sx={{ position: 'fixed' }}>
  <Toolbar>
    ...
    <Button style={{backgroundColor:'#2a68af',border:'1px solid #2a68af'}} autoFocus color="inherit" onClick={handleClose3}>
      Close
    </Button>
  </Toolbar>
...
<span style={{color:'#2a68af',fontWeight:'bold'}}>DESCRIPTION</span>
</Modal.Header>
...
<Modal
  ...
  >
    ...
    <Modal.Body>
      ...
      <div>
      <Button onClick={onUpload} component="span" style={{backgroundColor:'#2a68af',border:'1px solid #2a68af',marginTop:5}}>
        {loading === true ?(
          <>Uploading...</>
        ):(
          <>Upload</>
