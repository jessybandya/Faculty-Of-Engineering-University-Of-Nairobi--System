     ...
     >
       ...
       <Tab label="Gallery" {...a11yProps(2)} />
        ...
        {submitComment === "" ?(
            ...
            <SendOutlined onClick={submitCommentFun} style={{marginRight:20,marginLeft:3,cursor:'pointer',fontSize:'20px',color:'#2a68af'}}/>
        )}
        </div>
         </center>
        ): value === 0 ?(
            ...
            {post?.status === true ?(
                ...
                {auth?.currentUser?.uid ?(
                    <Button onClick={authFun} style={{backgroundColor:'#2a68af', border:'1px solid #2a68af',color:'#fff'}} variant="contained">
                    {loading === true ?(
                    ...
                    <Button onClick={() => setModalShow1(true)} style={{backgroundColor:'#2a68af', border:'1px solid #2a68af',color:'#fff'}} variant="contained">
                    {loading === true ?(
                      <span><span style={{color:'#fff'}}>attending...<Spin size="middle" /></span></span>
                    ):(
                      <span>Attend</span>
             ...
             <Button style={{backgroundColor:'#2a68af', border:'1px solid #2a68af',color:'#fff'}} variant="contained">
